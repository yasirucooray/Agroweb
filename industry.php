...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
          ...
          <a class="dropdown-item" href="industry-profile-update.php">Update account</a>
    ...
    <section class="ftco-section">
        ...
        <section class="ftco-section ftco-no-pt ftco-no-pb py-5 " style="background-image: url('images/profileadd.jpg'); background-repeat: no-repeat;background-attachment: fixed;background-size: cover; ">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    if(mysqli_num_rows($result)==0){
                      echo'
                        <form action="industrydetails.php" method="post" >
					    <h3 class="mb-4 billing-heading">Make a Company Profile</h3><br>
	          	        <div class="row align-items-end">
	          		        <div class="col-md-6">
	                            <div class="form-group">
                                     <label for="firstname">Company Name</label>
                                        <input type="text" class="form-control" placeholder="" name="cname" value="';?><?php echo $sesion ?><?php echo'"  readonly>
	                            </div>
	                        </div>
	                        <div class="col-md-6">
	                            <div class="form-group">
                              <label for="streetaddress"> Product Type</label>
                              <select name="ptype">
                              <option class="form-control"  required > TEA </option>
                              <option class="form-control"  required > RUBBER </option>
                              <option class="form-control" placeholder=""  required > CINNAMON </option>
