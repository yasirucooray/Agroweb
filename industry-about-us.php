  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <a class="navbar-brand" href="index.html"><img src="images/logo1.png"  width="280" height="100"></a>
        ...
        <li class="nav-item"><a href="industry-map.php" class="nav-link">Map</a></li>  
			  <li class="nav-item"><a href="" class="nav-link">About_Us</a></li>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/plantation.jpeg');">
      <div class="container">
...
<br>
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/tea1.jpeg);">
						<a href="http://localhost/vegefoods/images/agroweb.mp4" class="icon popup-vimeo d-flex justify-content-center align-items-center">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to AgroWeb Plantation and Industry Collabaration System</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
