...
$result = mysqli_query($mysqli, "SELECT * FROM news where poster_name='{$_SESSION['name']}' ");
...
$sql="SELECT * FROM news  where poster_name='{$_SESSION['name']}' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($mysqli, $sql);
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        ...
        while($res = mysqli_fetch_array($result)) {         
          ...
          echo '	<div class="overlay"></div>
                    ...
                    echo "<a href=\"industryadd-news.php?id=$res[id]\">Read more....</a> <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"></a><br>";    echo "</h4></p>";    
                     echo "<a href=\"update_news.php?id=$res[id]\">Update</a> | <a href=\"ind-news-delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a><br>";    echo "</h4></p>";     
        ...
        echo'<li class="active">';
          echo '<a class=""  href="news-industry.php?page=' . $page . '">' . $page . '</a> ';
          echo'</li>&nbsp';
        }
        ?>
        </ul>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb py-5 " style="background-image: url('images/newsadd.jpg'); background-repeat: no-repeat;
  ...
  background-size: cover; ">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center mb-3 pb-3">
  			    <div class="col-md-12 heading-section text-center ftco-animate">
	 			    <span class="subheading">Post latest news</span>
             </div>
		</div> 
                    <form action="news-insert.php" class="p-5 " method="post" >
                  <div class="form-group">
                    <label style="color:green;">Name </label>
                    <input type="text" class="form-control" name="name" id="name" value="<?php echo $sesion;?>" Readonly>
                  </div>
                  <div class="form-group">
                  <label style="color:green;">Tital </label>
                  ...
                  <br>
                  <div class="form-group">
                    <label style="color:green;">Image</label>
