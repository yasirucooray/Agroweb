...
$sql='SELECT * FROM company_profile where product_type="tea" ';
$result = mysqli_query($mysqli, $sql);

$sql1='SELECT * FROM company_profile where product_type="cinnomen" ';
$result1 = mysqli_query($mysqli, $sql1);

$sql2='SELECT * FROM company_profile where product_type="RUBBER" ';
$result3 = mysqli_query($mysqli, $sql2);
 // using mysqli_query instead
 $query = "SELECT ind_name FROM company_profile where product_type!='SHOP'";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/hands.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">industry</a></span> <span>Details</span></p>
            <h1 class="mb-0 bread">Membership Area</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
                      ...
                      <form action="member_rej.php" method="post" >
                      <?php include('errors.php'); ?>
					    <h3 class="mb-4 billing-heading">Get a membership</h3><br>
	          	        <div class="row align-items-end">
	          		        <div class="col-md-12">
	                            <div class="form-group">
                                     <label for="firstname">Username Name</label>
                            ...
                            <div class="col-md-12">
                                <div class="cart-detail p-3 p-md-4">
                                        ...
                                        <div class="col-lg-6 mb-5 ftco-animate">
                                            <input type="submit" class="btn btn-primary py-3 px-4" name="submit"  value="Request">
									    </div>
                                </div>
                            </div>
	                    </div>
          ...
          <div class="sidebar-box">
            ...
            <div class="container">
             <h3 class="heading"> Available Tea Factories </h3>
             <?php
            ...
            while($res = mysqli_fetch_array($result)) { 
             echo ""  .$res['ind_name']."<br></h3>"; 
            }
            ?><br>
            <h3 class="heading"> Available Cinnomen Factories </h3>
             <?php
            ...
            while($res1 = mysqli_fetch_array($result1)) { 
             echo ""  .$res1['ind_name']."<br></h3>"; 
            }
            ?><br>
              <h3 class="heading"> Available Rubber Factories </h3>
             <?php
