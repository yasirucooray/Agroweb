...
$result = mysqli_query($mysqli, "SELECT * FROM company_profile c join membership m on c.ind_name=m.industry_name WHERE member_name='{$_SESSION['username']}'");
...
<div class="container emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-3">
                <?php
                    echo " <a class='btn btn-primary' href=\"ressign-company.php?id=$id\" onClick=\"return confirm('Are you sure you want to Remove membership?')\">Remove Membership</a><br>";         
     ?>
                </div></div>
                <div class="row">
                    <div class="col-md-4">
