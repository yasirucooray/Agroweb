...
$result = mysqli_query($mysqli, "SELECT * FROM techno ");
...
$sql='SELECT * FROM techno LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>New Technology</span></p>
            <h1 class="mb-0 bread">New Technology</h1>
          </div>
        </div>
      </div>
    </div><br><br>
    <div class="container">
		<div class="row justify-content-center mb-3 pb-3">
  			<div class="col-md-12 heading-section text-center ftco-animate">
				 ...
				 <h2 class="mb-4">New Technolgy in Plsntstion industry </h2>
         <p> You can see ,read and post any new technology that can be used on plantation industry. using new technology planters can improve their cultivation. and users can leran new technology
         and how it used for youre bussiness. and you can post any comment each post. This new Technologys add by industry, users and administrate of this web applicatio.</p>
    ...
    <?php
        ...
        //while($res = mysql_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array
          ...
          $s=$res['image'];
    echo '<img src="images/'.$s.'" class="img-fluid" style="width:505px;height:255px;">'; 
    $sa=$res['id'];
    $result5 = mysqli_query($mysqli,"SELECT * FROM techno_comment where tech_id='$sa'");
    $rows5 = mysqli_num_rows($result5);
    
		              echo'<div class="text d-block pl-md-4">';
                  echo'	<div class="meta mb-3">'; 
                  echo "<h4>".$res['tital']."</h4>";
                      echo "<div><span class='icon-calendar'></span>"  .$res['timestamp']."</div>";
                      echo "<div><span class='icon-person'></span>"  .$res['poster_name']."</div>";
                      echo'<div><a href="#" class="meta-chat"><span class="icon-chat"></span> Comments';  echo " $rows5 "; echo'</a></div>';
                      echo' </div>';
                     
                        echo "<h6>".substr($res['infor'],0,350)."</h6>";
                        echo "<a href=\"technology-single.php?id=$res[id]\">Read more....</a> <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"></a><br>";    echo "</h4></p>";    
                        echo' </div>
		            </div>
		          </div>';
                  echo'<br>';
...
<div class="row mt-5">
          <div class="col text-center">
            <div class="block-27">
        <ul><h4>More Postss</h4>
        <?php for ($page=1;$page<=$number_of_pages;$page++) {
        echo'<li class="active">';
          echo '<a class=""  href="new-techno.php?page=' . $page . '">' . $page . '</a> ';
          echo'</li>&nbsp';
        }
        ?>
        </ul>
