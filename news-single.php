...
$result3 = mysqli_query($mysqli, "SELECT * FROM news_comment where news_id='$id' ");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/news2.jpg');">
      <div class="container">
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td><input type="hidden" name="update" value="Update"></td>
						...
						<h2 class="mb-3"><?php echo $tital;?></h2>
         ...
         echo'     </div>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="comment-form-wrap pt-5">
                ...
                <form action="news-comment.php" class="p-5 bg-light" method="post">
                  <div class="form-group">
                   
                    <input type="hidden" class="form-control" name="name" id="name" value="<?php echo $sesion;?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="submit" name="submit" value="Comment" class="btn py-3 px-4 btn-primary">
                  </div>
