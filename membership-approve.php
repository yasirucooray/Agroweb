...
$sql="SELECT * FROM  membership join user on membership.user_id=user.user_id  WHERE industry_name='{$_SESSION['name']}' AND confirmation='Pending' ";
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Requested Planters</h1>
          </div>
        </div>
      </div>
    </div>
...
while($res = mysqli_fetch_array($result)) { 
    ...
    $s=$res['image'];
    echo '    <td class="image-prod"><img src="images/'.$s.'" class="block-20" style="width:200px;height:100px;"></td>';			        
    echo '     <td class="product-name">';
    echo '      	<h3>'; echo ""  .$res['member_name']."<br></h3>"; echo '</h3>';
    echo ' </td>';
    echo '<td class="price">'; echo ""  .$res['email']."<br></h3>"; echo ' </td>';
    echo '  <td class="total">'; echo "<a href=\"membership-accept.php?id=$res[member_id]\">View</a> | <a href=\"reject-member.php?id=$res[member_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Reject</a><br><br>";    echo "</h4></p>"; 
    echo ' </tr>'; }
?>
     </tbody>
				</table>
