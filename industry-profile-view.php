...
<div class="container emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-2">
                     <a href="reject-member.php?id=$res[member_id]" onClick="return confirm('Are you sure you want to delete?')">Remove membership</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
            ...
            <form name="form1" method="post" action="sales-infor.php" class="p-5 bg-light">
            <h3 class="mb-4 billing-heading">Mounthly Account</h3><br>
	          	        <div class="row align-items-end">
	          		        <div class="col-md-6">
	                            <div class="form-group">
                                     <label for="firstname">Member Name</label>
                                     <input type="text" class="form-control" id="username" name="mname" value="<?php echo $name;?>" readonly>
	                            </div>
	                        </div>
	                        <div class="col-md-6">
	                            <div class="form-group">
                              <label for="streetaddress"> Company Name</label>
                              <input type="text" class="form-control" id="username" name="cname" value="<?php echo $_SESSION['name'];?> "readonly>
	                            </div>
                            </div>
		                    ...
		                    <div class="col-md-6">
		            	        <div class="form-group">
	                	            <label for="towncity">Month</label>
                                    <input type="month" class="form-control" id="name" name="month" require>
                                </div>
                            </div>
                            <div class="col-md-6">
		            	        <div class="form-group">
	                	            <label for="towncity">Amount of materials supplied</label>
                                    <input type="text" class="form-control" id="name" name="sup" require>
	                            </div>
		                    </div>
		                    <div class="w-100"></div>
		                    <div class="col-md-6">
		            	        <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="price" require>
	                            </div>
		                    </div>
                            <div class="col-md-6">
		            	        <div class="form-group">
		            		        <label for="postcodezip">Total</label>
