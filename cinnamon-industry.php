...
$sql='SELECT * FROM company_profile where product_type="cinnamon" LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/cinnamonin.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">industry</a></span> <span>Details</span></p>
            <h1 class="mb-0 bread">Cinnamon Sector</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        ...
        echo '<img src="images/'.$s.'" class="block-20" style="width:350px;height:170px;">';      
          ...
          echo "Name <t>"  .$res['ind_name']."<br></h3>";  
          echo'<div class="meta mb-3">';
          echo'   <div><a href="#">';echo ""  .$res['product_type']."";echo'</a></div>';
   
          echo'   <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>';
          echo '<p>'; echo " <t>"   .substr($res['discription'],0,300)."</br></p>";
          echo "<a href=\"tea-main.php?id=$res[id]\">Read more....</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"></a><br>";    echo "</h4></p>";    
        }  
        echo '<br><br></div>';?>
      ...
      <button type="submit"><i class="fa fa-search"></i></button>
            ...
            <div class="container">
             ...
             <div class="col-lg-6 mb-5 ftco-animate">
               <a href="membership.php" >    <Button class="btn btn-primary py-3 px-4" >Membership</button></a>
									</div>
             </div>
             </div>
          </div>
    ...
    <div class="row mt-5">
          <div class="col text-center">
            <div class="block-27">
        <ul><h4>More Industrys</h4>
        <?php for ($page=1;$page<=$number_of_pages;$page++) {
        echo'<li class="active">';
          echo '<a class=""  href="Tea-industry.php?page=' . $page . '">' . $page . '</a> ';
          echo'</li>&nbsp';
        }
        ?>
        </ul>
