...
$result6 = mysqli_query($mysqli,"SELECT * FROM shop ");
$rows6 = mysqli_num_rows($result6);


$result7 = mysqli_query($mysqli,"SELECT * FROM user ");
$rows7 = mysqli_num_rows($result7);


$result8 = mysqli_query($mysqli,"SELECT * FROM company_profile ");
					...
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);  background-repeat: no-repeat; ">
...
$s=$res['image1'];
    ...
    echo'   </a>';
                      ...
                      echo'  <p>';echo""  .$res['infor'].""; echo'</p>';
                      echo'  <p><a href="blog-single.html" class="btn btn-primary py-2 px-3">Read more</a></p>';
                      echo' </div>';
                      echo'   </div>';}
                    ?>
		          </div>
    			...
    			<div class="col-md-10">
		          ...
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="<?php echo " $rows7 ";?>">0</strong>
		                <span>Planters</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                ...
		                <strong class="number" data-number="<?php echo " $rows8";?>">0</strong>
		                <span>Plantation Companys</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="<?php echo " $rows6 ";?>">0</strong>
		                <span>Products for sell</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="<?php echo " $rows5 ";?>">0</strong>
